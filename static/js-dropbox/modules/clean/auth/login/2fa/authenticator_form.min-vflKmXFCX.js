define(["require", "exports", "tslib", "classnames", "react", "modules/core/i18n", "modules/clean/auth/common/inputs/text", "modules/clean/auth/common/types", "modules/clean/auth/common/utils", "modules/clean/auth/login/2fa/trust_checkbox"], (function(e, t, a, n, o, i, l, r, u, s) {
    "use strict";
    Object.defineProperty(t, "__esModule", {
        ...
        return o.default.createElement("form", {
            ...
            defaultMessage: "Enter the code generated by your authenticator app."
        })), o.default.createElement("div", {
            className: n.default({
            ...
            value: e.value,
            placeholder: i.intl.formatMessage({
            ...
            autoFocus: !0,
            autoComplete: !1
        }), e.inlineSubmit && t), !e.hideTrustCheckbox && o.default.createElement(s.TwoFactorTrustCheckbox, {
            checked: e.trusted,
            maestroStyle: e.maestroStyle,
            onChange: e.onInputChange,
...
//# sourceMappingURL=authenticator_form.min.js-vflK0uovR.map