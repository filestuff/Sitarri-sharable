define(["require", "exports", "tslib", "classnames", "react", "modules/core/i18n", "modules/clean/auth/common/error", "modules/clean/auth/common/types", "modules/clean/auth/common/utils", "modules/clean/components/password_strength_meter"], (function(e, t, s, r, a, o, l, p, n, i) {
    "use strict";
    ...
    var u = function(e) {
            var t = e.error && (e.error.message_html || e.error.message_text),
                ...
                n = o.intl.formatMessage({
                    defaultMessage: "Good passwords are hard to guess. Use uncommon words or inside jokes, non-standard uPPercasing, creative spelllling, and non-obvious numbers and symbols"
                });
...
//# sourceMappingURL=text.min.js-vflg3K18e.map