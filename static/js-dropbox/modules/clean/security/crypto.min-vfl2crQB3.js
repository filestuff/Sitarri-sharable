define(["require", "exports", "tslib", "modules/core/browser_detection", "modules/clean/security/util"], (function(e, t, r, n, i) {
    ...
    function o() {
        return r.__awaiter(this, void 0, Promise, (function() {
            ...
            return r.__generator(this, (function(o) {
                switch (o.label) {
                    case 0:
                        return void 0 === window.crypto || void 0 === window.crypto.subtle || !0 === n.edge && !n.edgeChromium() ? [4, new Promise((function(t, r) {
                            e(["modules/clean/security/mscrypto_shim"], t, r)
                        })).then(r.__importStar)] : [2, window.crypto];
                    case 1:
                        if (t = o.sent().msCryptoWrapper, void 0 !== (i = t())) return [2, i];
    ...
    Object.defineProperty(t, "__esModule", {
        value: !0
    }), n = r.__importStar(n), t.encryptWithPublicKey = function(e, t, n) {
        return r.__awaiter(this, void 0, Promise, (function() {
            var s = this;
                    ...
                    return r.__awaiter(s, void 0, void 0, (function() {
                        ...
                        return r.__generator(this, (function(r) {
                            switch (r.label) {
                                ...
                                case 5:
                                    return d = r.sent(), l = new ArrayBuffer(2), new DataView(l).setInt16(0, n), [2, i.concatenateArrayBuffers(l, d, s, a)]
                            }
                        }))
                    }))
                }))]
...
//# sourceMappingURL=crypto.min.js-vflFaAJy_.map