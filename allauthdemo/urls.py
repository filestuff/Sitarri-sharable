...
from .auth.views import account_profile, integrations_action, product_create_view
...
urlpatterns = [
    ...
    # url(r'^dashboard/panels$', TemplateView.as_view(template_name='dashboard/panels.html'), name='user_panels'),
    # Landing page area
    ...
    url(r'^dashboard/panels/$', integrations_action, name='integrations_action'),
    url(r'^dashboard/new_product/$', product_create_view, name='new_product'),
